...
function dataTrainValid = DBNModel_TVT(inter_structure, dataTrain, dataTrainMiss, dataValid, dataTest, ns, dag, max_iter, intraLength, horizon, numNodes,ncases, onlyValid) %add dataTest to this function

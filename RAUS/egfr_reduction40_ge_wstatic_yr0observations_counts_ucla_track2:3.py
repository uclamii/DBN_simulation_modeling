...
```shell
$ screen -S egfr_reduction40_ge_wstatic_raus_track2:3 python egfr_reduction40_ge_wstatic_yr0observations_nocounts_track2:3.py
...
track2 = (
    ...
    + rank_filter
    + "  --cv_rank_filter2 "
    + Contemporals_Filter_keep_counts
    + "  --track "
    + Track2
    + "  --site "
    + UCLA_counts
    + "  --adjusted "
    + Contemporals_Substructure
    + "  --outcome_name "
    + Outcome
    + "  --max_fan_in "
    + max_fan_in
    ...
    + "  --cols_start "
    + Contemporals_InitialCondition_COLS_Start
    + "  --cols_end "
    + COLS_End
    + "  --COLS "
    + Contemporals_COLS

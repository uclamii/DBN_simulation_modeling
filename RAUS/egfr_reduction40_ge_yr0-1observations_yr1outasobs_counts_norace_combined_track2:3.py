...
```shell
$ screen -S egfr_reduction40_ge_yr0-1_yr1outasobs_raus_track2:3 python egfr_reduction40_ge_yr0-1observations_yr1outasobs_nocounts_track2:3.py
...
track2 = (
    ...
    + Track2
    + "  --site "
    + Combined_counts_no_race
    + "  --adjusted "
    + Initial_Condition_Substructure
    + "   --outcome_name "
    + Outcome
    + "  --max_fan_in "
    + max_fan_in

...
if __name__ == "__main__":
    ...
    for site in sites:
        results_path = "./Data/genie_datasets/DBN_predictions/Results/CIs_results/stratified/"
            ...
            for filter_group in filter_groups:
                ...
                for metric in metrics:
                    ...
                    cond = (
                        ...
                        & (df_results["Dataset"].str.contains("discritizer_tested_on"))
                    )

...
if __name__ == "__main__":
    ...
    df_inter = pd.read_csv(
        "../Data/simulation_structures/simple_model/csv_files_four_structures_nocounts_variables/chisquarerank_inter_structure_w_column_names_egfr_reduction40_ge_UCLA_nocounts_w_Race_Adjusted_Variables_Track1.csv",
        index_col=0,
    )
    ...
    df_intra_year0_1 = pd.read_csv(
        "../Data/simulation_structures/simple_model/csv_files_four_structures_nocounts_variables/chisquarerank_intra_structure_w_column_names_egfr_reduction40_ge_UCLAw_yr0-1observations_yr1outasobs_nocounts_w_Race_Adjusted_Variables_Track2:3.csv",
        index_col=0,
    )
    ...
    df_intra_year1 = pd.read_csv(
        "../Data/simulation_structures/simple_model/csv_files_four_structures_nocounts_variables/chisquarerank_intra_structure_w_column_names_egfr_reduction40_ge_UCLAw_yr1observations_nocounts_w_Race_Adjusted_Variables_Track2:3.csv",
        index_col=0,
    )
    ...
    df_intra_static_year0 = pd.read_csv(
        "../Data/simulation_structures/simple_model/csv_files_four_structures_nocounts_variables/chisquarerank_intra_structure_w_column_names_egfr_reduction40_ge_UCLAwstatic_yr0observations_nocounts_w_Race_Adjusted_Variables_Track2:3.csv",
        index_col=0,
    )
    ...
    # save file
    cure_ckd_bn.save_BN(filename="CURE_CKD_BN_no_counts.xdsl")

    # load file
    cure_ckd_bn.load_BN(filename="CURE_CKD_BN_no_counts.xdsl")
    ...
    for filename in filenames:
        ...
        # save predictions
        df_valid.to_csv(
            "../Data/genie_datasets/DBN_predictions/simple_var_model/"
